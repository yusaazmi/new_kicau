	...
	<div class="ads-grid_shop">
		<div class="shop_inner_inf">
			<div class="privacy about">
				<h3>Stat<span>us Pesanan</span></h3>
					...
					<table class="timetable_sub">
						...
						<tbody>
							...
							<tr class="rem1">
								...
								@if($c->status === 'settlement')
								<td class="invert"><span class="badge badge-primary">Settlement</span></td>
								<td class="invert">
									<span class="badge badge-primary">Lunas</span>
								</td>
								@if($c->status_cod === 'Belum Cod')
								<td class="invert"><a href="/status/update_cod/{{$c->order_id}}" class="btn btn-success">Lakukan Cod</a></td>
								@else
								<td class="invert"><span class="badge badge-success">{{$c->status_cod}}</span></td>
								@endif
								@else
								<td class="invert">{{$c->status}}</td>
								<td class="invert">
									<a href="/payment/{{$c->snap_token}}">Pembayaran</a>
                                </td>
								<td class="invert">{{$c->status_cod}}</td>
								@endif
