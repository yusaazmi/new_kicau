        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <form class="form-horizontal" method="POST" action="/seller/bird/edit/{{$birds->id}}" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <h4 class="card-title">Form Edit Burung</h4>
                                    <div class="form-group row">
                                        <label for="jenis_burung"
                                            class="col-sm-3 text-end control-label col-form-label">Jenis Burung</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="jenis_burung" name="jenis_burung" value="{{$birds->jenis_burung}}" placeholder="Jenis Burung">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="umur" class="form-control" id="umur"
                                                placeholder="Umur Burung" value="{{$birds->umur}}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="harga"
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number"  class="form-control" id="harga"
                                                placeholder="Harga Burung" name="harga" value="{{$birds->harga}}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="cono1"
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control" name="deskripsi">{{$birds->deskripsi}}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="cono1"
